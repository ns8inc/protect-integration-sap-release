...
import com.ns8.hybris.sampledataaddon.constants.Ns8sampledataaddonConstants;



/**
 * This is the extension manager of the Ns8sampledataaddon extension.
 */
public class Ns8sampledataaddonManager extends GeneratedNs8sampledataaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Ns8sampledataaddonManager.class.getName());
	 ...
	 */
	public static Ns8sampledataaddonManager getInstance()
	{
		return (Ns8sampledataaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Ns8sampledataaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Ns8sampledataaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Ns8sampledataaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Ns8sampledataaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Ns8sampledataaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
