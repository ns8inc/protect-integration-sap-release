 ...
 */
package com.ns8.hybris.backoffice.jalo;
...
import com.ns8.hybris.backoffice.constants.Ns8backofficeConstants;
 ...
 */
public class Ns8backofficeManager extends GeneratedNs8backofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Ns8backofficeManager.class.getName());
	 ...
	 */
	public static Ns8backofficeManager getInstance()
	{
		return (Ns8backofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Ns8backofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Ns8backofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Ns8backofficeManager called.");
		}
	}
