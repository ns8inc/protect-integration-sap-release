 ...
 */
package com.ns8.hybris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Ns8fulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Ns8fulfilmentprocessConstants.PARENT_PROCESS);
