 ...
 */
package com.ns8.hybris.addon.jalo;
...
import com.ns8.hybris.addon.constants.Ns8addonConstants;



/**
 * This is the extension manager of the Ns8addon extension.
 */
public class Ns8addonManager extends GeneratedNs8addonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Ns8addonManager.class.getName());
	 ...
	 */
	public static Ns8addonManager getInstance()
	{
		return (Ns8addonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Ns8addonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Ns8addonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Ns8addonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Ns8addonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Ns8addonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
